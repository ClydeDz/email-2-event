...
function statusDescription(status: string): string {
  switch (status) {
    ...
    case "unavailable":
      return "Gemini Nano is not available on this device. It requires compatible hardware (≥4 GB VRAM or capable iGPU), Chrome 138+, and all Chrome AI flags enabled. Please check chrome://flags and enable all Prompt API and Gemini Nano related flags.";
    default:
